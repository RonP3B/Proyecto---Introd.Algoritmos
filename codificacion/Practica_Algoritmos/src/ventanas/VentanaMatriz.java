...
public class VentanaMatriz extends javax.swing.JDialog {
    ...
    public VentanaMatriz(java.awt.Frame parent, boolean modal, String contenido) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        Label_Titulo.setText("Matriz de dimensión 4x4");
        getContentPane().add(Label_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 20, -1, -1));
        ...
        Label_Contenido.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        getContentPane().add(Label_Contenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 400, -1));
        ...
        getContentPane().add(Btn_CapturarValor, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 320, 320, 35));
        getContentPane().add(Label_Fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 420, 370));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                VentanaMatriz dialog = new VentanaMatriz(new javax.swing.JFrame(), true, "");
